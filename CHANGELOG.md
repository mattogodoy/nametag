...
* add auto-redirect on login when credentials are disabled and exactly one SSO provider is enabled
* add provider helper for detecting a single enabled SSO provider

...
import { addPhotoToVCardFromUrl, downloadVcf, generateVcfFilename } from '@/lib/vcard-client-utils';
              ...
              {candidates.map((candidate) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-2 py-1 text-xs font-semibold rounded bg-primary text-on-primary hover:bg-primary-dark transition-colors flex-shrink-0"
                  >
                    {tDup('merge')}
                  </Link>
                </div>
      ...
      <Modal isOpen={showQrModal} onClose={() => setShowQrModal(false)} title={t('contactQrCode')}>
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="px-4 py-2 bg-primary text-on-primary rounded-lg font-semibold hover:bg-primary-dark transition-colors"
          >
            {t('close')}
          </button>
        </div>

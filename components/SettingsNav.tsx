...
const allSettingsNavItems = [
  ...
  {
    href: '/settings/map',
    labelKey: 'settings.map.title',
    descriptionKey: 'settings.map.description',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    labelKey: 'customFields.settings.title',
    descriptionKey: 'customFields.settings.description',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    labelKey: 'settings.apiTokens.title',
    descriptionKey: 'settings.apiTokens.description',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="md:hidden bg-surface shadow rounded-lg p-4">
        ...
        <div className="relative">
          <select
            ...
            className="block w-full rounded-lg border border-border bg-surface text-foreground shadow-sm focus:border-primary focus:ring-primary py-2.5 pl-3 pr-10 text-base appearance-none"
          >

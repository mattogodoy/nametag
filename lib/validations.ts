...
export const mergePersonSchema = z.object({
  ...
  fieldOverrides: z.object({
    ...
    anniversary: z.iso.date({ error: 'Invalid date' }).nullable().optional(),
...
export const importDataSchema = z.object({
  ...
  people: z.array(z.object({
    ...
    notes: z.string().nullable().optional(),
    contactReminderEnabled: z.boolean().optional(),
    contactReminderInterval: z.number().nullable().optional(),
    contactReminderIntervalUnit: z.string().nullable().optional(),

      ...
      schemas: {
        ...
        Person: {
          ...
          properties: {
            ...
            lastContact: { type: 'string', format: 'date-time', nullable: true, description: 'Date of last contact' },
            notes: { type: 'string', nullable: true, description: 'Markdown-formatted notes' },
            contactReminderEnabled: { type: 'boolean' },
            contactReminderInterval: { type: 'integer', minimum: 1, maximum: 99, nullable: true },
            contactReminderIntervalUnit: { $ref: '#/components/schemas/ReminderIntervalUnit' },
            relationshipToUser: { $ref: '#/components/schemas/RelationshipTypeSummary' },
            groups: {
              type: 'array',
              items: {
                type: 'object',
        ...
        Relationship: {
          ...
          properties: {
            ...
            relationshipType: { $ref: '#/components/schemas/RelationshipTypeSummary' },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        ...
        ImportantDate: {
          ...
          properties: {
            ...
            reminderType: { type: 'string', enum: ['ONCE', 'RECURRING'], nullable: true },
            reminderInterval: { type: 'integer', minimum: 1, maximum: 99, nullable: true },
            reminderIntervalUnit: { $ref: '#/components/schemas/ReminderIntervalUnit' },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        ...
        UpcomingEvent: {
          ...
          required: ['id', 'personId', 'personName', 'type', 'title', 'date', 'daysUntil'],
        },
        GraphNode: {
          type: 'object',
          properties: {
        ...
        ImportantDateInput: {
          ...
          properties: {
            ...
            reminderEnabled: { type: 'boolean' },
            reminderType: { type: 'string', enum: ['ONCE', 'RECURRING'], nullable: true },
            reminderInterval: { type: 'integer', minimum: 1, maximum: 99, nullable: true, description: 'How many units between reminders' },
            reminderIntervalUnit: { $ref: '#/components/schemas/ReminderIntervalUnit' },
          },
          required: ['title', 'date'],
        },
        ...
        post: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              surname: { type: 'string', maxLength: 100, nullable: true },
              nickname: { type: 'string', maxLength: 100, nullable: true },
            },
        ...
        post: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              nickname: { type: 'string', maxLength: 100, nullable: true },
              lastContact: { type: 'string', format: 'date', nullable: true },
              notes: { type: 'string', maxLength: 10000, nullable: true },
              relationshipToUserId: { type: 'string', nullable: true, description: 'ID of the relationship type to the user' },
        ...
        put: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              lastContact: { type: 'string', format: 'date', nullable: true },
              notes: { type: 'string', maxLength: 10000, nullable: true },
              relationshipToUserId: { type: 'string', nullable: true },
        ...
        post: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              color: { type: 'string', nullable: true, description: 'Hex color' },
              inverseId: { type: 'string', nullable: true, description: 'ID of existing inverse type' },
        ...
        put: {
          ...
          requestBody: jsonBody({
            ...
            properties: {
              ...
              color: { type: 'string', nullable: true },
              inverseId: { type: 'string', nullable: true },
